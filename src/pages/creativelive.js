...
import Img from '../images/creativelive.svg'
...
let link = `https://www.creativelive.com/`
    ...
    return(
        ...
        <div className={`page ${style.page}`}>
            ...
            <div className={style.pageContent}>
                ...
                <h4>
                Offer - Free content(limited)
                </h4>
                <h3>
                Master your craft, your passion with creative classes taught by the world’s best.
