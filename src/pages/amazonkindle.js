...
import Img from '../images/amazonkindle.svg'
...
let link = `https://www.amazon.com/Kindle-eBooks/b?ie=UTF8&node=154606011`
    ...
    return(
        ...
        <div className={`page ${style.page}`}>
            ...
            <div className={style.pageContent}>
                ...
                <h3>
                Get instant access to 1 Million+ titles and read anywhere!
                </h3>
