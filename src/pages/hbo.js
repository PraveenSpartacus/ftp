...
import Img from '../images/hbo.svg'
    ...
    return(
        ...
        <div className={`page ${style.page}`}>
            ...
            <div className={style.pageContent}>
                ...
                <h3>
                The official site for HBO, discover full episodes of original series, movies, exclusive video content and more.
