...
import Img from '../images/viglink.svg'
    ...
    return(
        <div className={`page ${style.page}`}>
            ...
            <div className={style.pageContent}>
                ...
                <h3>
                Create a better web by making every link intelligent and valuable. At Sovrn Commerce, formerly VigLink, we deliver revenue to publishers through content-driven-commerce with leverage, insight, and automation.    
                </h3>
