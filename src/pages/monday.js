...
import Img from '../images/monday.svg'
...
import wrike from '../images/wrike.svg'

let link = 'https://www.monday.com/'
    ...
    return(
        ...
        <div className={`page ${style.page}`}>
            ...
            <div className={style.pageContent}>
                ...
                <h3>
                monday.com is the Work OS that powers teams to run processes, projects and everyday work their way.
                ...
                <div className={style.related}> 
                    ...
                    <Link className={style.notVisible} to="/wrike"><img src={wrike} alt="img"></img></Link>
