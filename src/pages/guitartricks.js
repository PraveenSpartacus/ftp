...
import Img from '../images/guitartricks.svg'
...
import guitargate from '../images/guitargate.svg'


let link = 'https://www.guitartricks.com/'
    ...
    return(
        ...
        <div className={`page ${style.page}`}>
            ...
            <div className={style.pageContent}>
                ...
                <h3>
                LEARN TO PLAY GUITAR THE EASY, FAST and FUN, WAY!
                ...
                <div className={style.related}> 
                    ...
                    <Link className={style.notVisible} to="/guitargate"><img src={guitargate} alt="img"></img></Link>
