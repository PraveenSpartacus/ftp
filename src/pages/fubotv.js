...
import Img from '../images/fubotv.svg'
...
let link = 'https://www.fubo.tv/lp/StreamTV/'
    ...
    return(
        ...
        <div className={`page ${style.page}`}>
            ...
            <div className={style.pageContent}>
                ...
                <h3>
                Watch your favorite teams, network shows, news and movies on 100+ channels.
                ...
                <div className={style.related}> 
                    ...
                    <Link className={style.notVisible} to="/crunchyroll"><img src={crunchyroll} alt="img"></img></Link>
                </div>
            </div>
