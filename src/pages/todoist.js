...
import Img from '../images/todoist.svg'
...
let link = 'https://www.todoist.com/'
    ...
    return(
        ...
        <div className={`page ${style.page}`}>
            ...
            <div className={style.pageContent}>
                ...
                <h3>
                Todoist has helped millions of people complete over 1.5 billion tasks in 150+ million projects.
